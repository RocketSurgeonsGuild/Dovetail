...
public static partial class Exports
{
    ...
    {
        yield return new DovetailJointMetadata(new Contrib1(), DovetailHostType.Undefined, DovetailCategory.Application);
        yield return new DovetailJointMetadata(new Contrib2(), DovetailHostType.Undefined, DovetailCategory.Application);
        yield return new DovetailJointMetadata(new Contrib3(), DovetailHostType.Undefined, DovetailCategory.Application);
        yield return new DovetailJointMetadata(new Contrib4(), DovetailHostType.Undefined, DovetailCategory.Application);
    }
}
