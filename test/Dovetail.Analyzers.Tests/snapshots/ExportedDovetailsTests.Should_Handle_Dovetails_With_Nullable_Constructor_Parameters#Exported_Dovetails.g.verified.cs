...
public static partial class Exports
{
    ...
    {
        yield return new DovetailJointMetadata(new Rocket.Surgery.LaunchPad.Mapping.AutoMapperDovetail(builder.Properties.GetService<Rocket.Surgery.LaunchPad.Mapping.AutoMapperOptions>()), DovetailHostType.Undefined, DovetailCategory.Application);
    }
}
