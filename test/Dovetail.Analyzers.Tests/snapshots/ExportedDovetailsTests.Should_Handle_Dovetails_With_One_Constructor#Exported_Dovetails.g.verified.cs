...
public static partial class Exports
{
    ...
    {
        yield return new DovetailJointMetadata(new Dovetail.Tests.ParentContrib.Contrib(builder.Properties.GetService<Dovetail.Tests.IService>(), builder.Properties.GetService<Dovetail.Tests.IServiceB>(), builder.Properties.GetService<Dovetail.Tests.IServiceC>()), DovetailHostType.Undefined, DovetailCategory.Application);
    }
}
