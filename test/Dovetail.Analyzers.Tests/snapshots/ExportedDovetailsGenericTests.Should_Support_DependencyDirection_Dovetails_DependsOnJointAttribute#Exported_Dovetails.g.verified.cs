...
public static partial class Exports
{
    ...
    {
        yield return new DovetailJointMetadata(new Dovetail.Tests.Contrib(), DovetailHostType.Undefined, DovetailCategory.Application).WithDependency(DependencyDirection.DependsOn, typeof(Dovetail.Tests.D));
    }
}
