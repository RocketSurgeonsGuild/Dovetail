...
SOURCE_BASE="https://github.com/RocketSurgeonsGuild/Dovetail/blob/main/src"
...
declare -A PACKAGES=(
  ["Dovetail"]="conventions"
  ["Dovetail.Abstractions"]="abstractions"
  ["Dovetail.Analyzers"]="analyzers"
  ["Dovetail.Autofac"]="autofac"
  ["Dovetail.Configuration.Json"]="configuration-json"
  ["Dovetail.Configuration.Yaml"]="configuration-yaml"
  ["Dovetail.Diagnostics"]="diagnostics"
  ["Dovetail.DryIoc"]="dryioc"
  ["Dovetail.Serilog"]="serilog"
