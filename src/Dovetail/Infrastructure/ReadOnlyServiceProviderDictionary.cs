...
internal class ReadOnlyDovetailDictionary : IReadOnlyDovetailDictionary
{
    private readonly ReadOnlyPropertiesType _values;

    /// <summary>
    ///     Initializes a new instance of the <see cref="ReadOnlyDovetailDictionary" /> class.
    /// </summary>
    /// <param name="values">The values.</param>
    public ReadOnlyDovetailDictionary(PropertiesType? values) => _values = new PropertiesDictionary(values ?? new RealDictionary());

    /// <summary>
    ///     Initializes a new instance of the <see cref="ReadOnlyDovetailDictionary" /> class.
    /// </summary>
    public ReadOnlyDovetailDictionary() => _values = new RealDictionary();
