...
internal interface IDovetailDictionary : IDictionary<object, object>, IServiceProvider
{
    /// <summary>
    ...
    IDovetailDictionary Set<T>(T value) where T : notnull
    {
        this[typeof(T)] = value;
        return this;
    }
    ...
    /// <param name="key">The key where the value is saved</param>
    /// <param name="value">The value to save</param>
    IDovetailDictionary Set(Type key, object value)
    {
        this[key] = value;
        return this;
    }
    ...
    /// <param name="key">The key where the value is saved</param>
    /// <param name="value">The value to save</param>
    IDovetailDictionary Set<T>(string key, T value) where T : notnull
    {
        this[key] = value;
        return this;
    }
    ...
    /// <typeparam name="T">The type of the value</typeparam>
    /// <param name="value">The value to save</param>
    IDovetailDictionary AddIfMissing<T>(T value) where T : notnull
    {
    ...
    /// <param name="key">The key where the value is saved</param>
    /// <param name="value">The value to save</param>
    IDovetailDictionary AddIfMissing(Type key, object value)
    {
    ...
    /// <param name="key">The key where the value is saved</param>
    /// <param name="value">The value to save</param>
    IDovetailDictionary AddIfMissing<T>(string key, T value) where T : notnull
    {
        if (TryGetValue(key, out _))
            return this;
